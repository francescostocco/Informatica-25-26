                    ...
                    <div class="structure-card">
                        ...
                        <div class="structure-body">
                            ...
                            <div class="structure-actions">
                                ...
                                <a 
                                    href="../structurepages/struttura.php?id=<?php echo $struttura['CodStruttura']; ?>" 
                                    class="view-btn"
                                >
                                    Visualizza
                                </a>
                                ...
                                <a 
                                    href="../actions/eliminastrutturaproprietario.php?id=<?php echo $struttura['CodStruttura']; ?>" 
                                    class="delete-btn"
                                    onclick="return confirm('Vuoi eliminare questa struttura? Verranno eliminate anche foto e recensioni.');"
                                >
                                    Elimina
                                </a>
